...
export default function EditarNoticiaPage() {
  ...
  useEffect(() => {
    const loadedArticle = getNewsById(articleId) || mockNews.find(a => a.id === articleId)
    if (loadedArticle) {
      ...
      setFormData({
        ...
        featured: loadedArticle.featured,
  ...
  const handleSave = () => {
    ...
    const success = updateNews(article.id, {
      ...formData,
      tags
    });
  ...
  const handleDelete = () => {
    ...
    const success = deleteNews(article.id);
